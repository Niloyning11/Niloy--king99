...
def main():
    stored_password = "Niloy"  # Replace with your stored password
    ...
    while True:
        ...
        if is_password_valid(user_password, stored_password):
            ...
            print("Welcome to Niloy KING TOOLS!")
            os.system('espeak -a 300 "Welcome to Niloy King Tools varson 2.7 ..."')
            time.sleep(2)
            os.system('clear')
...
os.system(f'xdg-open https://facebook.com/groups/901439714301627/')
#------------------[ Niloy-King ]-------------------#
#------------------[ USER-AGENT ]-------------------#
...
def back():
    login()
def contact():
   # os.system('xdg-open https://www.facebook.com/robin.sikder.568847')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mMR-NILOY ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • NILOY KING]    ║  \033[1;97m  
╠══[Github                   • \33[1;38mNILOY-KING ]   ║\33[1;34m   
...
def Subscraption():
    ...
    os.system('clear')
    print(logo)
    r1 = requests.get("https://github.com/Niloyning11/love.txt/blob/main/love.txt").text
    if id in r1:
        os.system('clear')
        print(logo)
    else:
        ...
        tks = f'https://wa.me/+8801786100329?text={message}'
...
os.system('clear')
print(logo)
os.system('espeak -a 300 " Your,   Real,  Name Niloy,"')
uname =input('\033[1;97m[\033[1;92m•\033[1;97m]\033[1;92m WHAT IS YOUR NAME \033[1;91m: \33[1;32m')
os.system('espeak -a 300 " Welcome,   to,  Niloy,  King,  Tools"')
pass
...
def menu():
    ...
    if Rakib in ['111']:
        ...
        os.system('xdg-open https://wa.me/+8801756829303')
        os.system("python nono.py")
    elif Rakib in ['3','03']:
        result()
    elif Rakib in ['0']:
